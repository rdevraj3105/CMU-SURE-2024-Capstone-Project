...
- Adult Obesity: percentage of the adult population that reports a body mass index greater than or equal to 30 kg/m^2^
...
#| fig-width: 9
#| fig-height: 5
#| fig-cap: "Figure 1: Relationships between child mortality and a sample of our predictor variables"
...
#| fig-width: 9
#| fig-height: 7
#| fig-cap: "Figure 2: Relationships between low birthweight and a sample of our predictor variables"
...
plot_grid(sleep_plot, smoke_plot, food_plot, obesity_plot)
...
#|fig-width: 8
#| fig-height: 8
#| fig-cap: "Figure 3: Percentage of low birthweight births by state, colored by the percentage of the county population reporting insufficient sleep"
...
healthdata_subset |> 
 mutate(state_abbreviation=factor(state_abbreviation), 
  ...
  geom_point(aes(x=state_abbreviation,y=low_birthweight_raw_value, fill = binary_sleep),size= 2, 
             alpha=0.65, shape=21)+
  ...
  theme(
    ...
    axis.title.y = element_text(face = "bold", color = "brown", size = 12),
    axis.title.x = element_text(face = "bold", color = "brown",vjust = -0.85, size = 12),
...
tidy_lasso_coef |> 
  ...
  theme(
    text = element_text(family = "Helvetica", size = 7, face = "bold", color = "#2a475e"),
    panel.grid = element_line(color = "#b4aea9"),
    panel.background = element_rect(fill = "#fbf9f4", color = "#fbf9f4"),
    plot.background = element_rect(fill = "#fbf9f4", color = "#fbf9f4"),
    legend.background =  element_rect(fill = "#fbf9f4", color = "#fbf9f4"),
...
birthweight_lm |> 
  ...
  theme(
    ...
    axis.title.x = element_text(size = 16, color = "#2a475e"),
    axis.title.y = element_text(size = 23, FALSE),
    axis.text.x = element_text(size = 17, color = "#2a475e"),
    axis.text.y = element_text(size = 12, color = "#2a475e")
  )
...
hr_tree |> 
  pluck("finalModel") |> 
  rpart.plot(tweak= 1, split.fun = split.fun, box.palette = c("white"))
...
IIn this report we investigated how juvenile health outcomes are affected by adult health behaviors. More specifically, we examined a multitude of health behaviors and their relationship to child mortality and low birthweight. 
...
## References
“Smoking, Pregnancy, and Babies.” Centers for Disease Control and Prevention, Centers for
 Disease Control and Prevention, 13 Oct. 2023,
 www.cdc.gov/tobacco/campaign/tips/diseases/pregnancy.html#:~:text=Smoking%. 

Chang, Jen Jen et al. “Sleep deprivation during pregnancy and maternal and fetal outcomes: is
 	is there a relationship?.” Sleep medicine reviews vol. 14,2 (2010): 107-14.
doi:10.1016/j.smrv.2009.05.001.

Grilo, Stephanie A et al. “Food Matters: Food Insecurity among Pregnant Adolescents and
Infant Birth Outcomes.” The journal of applied research on children : informing policy for children at risk vol. 6,2 (2015): 4.

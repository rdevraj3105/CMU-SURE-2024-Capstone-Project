...
```{r}
#| fig-cap: "Figure 1: Displays the relationships between child mortality and excessive drinking, adult smoking, and adult obesity at each county"
...
#| fig-cap: "Figure 2: Displays the relationships between the proportion of low birthweight births and the proportion of reported insufficient sleep at each county"
...
#| fig-cap: "Figure 3: Displays the percentage of low birthweight births by county, organized by state, as well as highlights the counties with over 75% of their population reporting insufficient sleep"
